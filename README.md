...
###  <font color="red">  Note: Use the live server of Visual Studio to start the User Login Page. Alternatively, use http://localhost:3000/login.html to initiate the GUI. This allows for easy navigation to other pages. A video demo demonstrating the navigation is provided; please check the video. </font>
